...
var schoolroute = {
     ...
     */
    get: function(user) {
        $.getJSON('/api/schoolroute?userid=' + user, function(json) {
...
var route = {
    ...
    get: function(user, date, togeko) {
        $.ajax({
            type: 'GET',
            url: '/api/route?userid=' + user + '&date=' + date.replace(/\//g, "") + '&type=' + togeko,
            dataType: 'xml'
        }).then(
            function(json) {
                route.data = json;
...
var rating = {
    ...
    get: function(user, date) {
        ...
        $.ajax({
            type: 'GET',
            url: '/api/rating?userid=' + user + '&date=' + date.replace(/\//g, ""),
            contentType:'application/json',
            dataType: 'json'
        })
        .then(function(json) {
...
var mapMemo = {
     ...
     */
    get: function() {
        $.getJSON('/api/marker', function(data) {
...
//                },
    ...
    delete: function(marker) {
        ...
        $.ajax({
            type: 'DELETE',
            url: '/api/marker?id=' + marker.btxid,
            dataType: 'text'
        }).then(
            function(result) {
                // 成功した場合
